...
func (r *NsBpfApplicationReconciler) getAppStateConditions() *[]metav1.Condition {
...
func (r *NsBpfApplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err := r.List(ctx, appPrograms, opts...); err != nil {
		return ctrl.Result{}, fmt.Errorf("failed getting BpfNsApplicationPrograms for full reconcile %s : %v",
			req.NamespacedName, err)
	}
	...
	for appProgramIndex := range appPrograms.Items {
		...
		if appState == nil {
			...
			// Create a new BpfApplicationState object first, once it's created,
...
func (r *NsBpfApplicationReconciler) createBpfAppState(ctx context.Context) (ctrl.Result, error) {
	// Create a new BpfApplicationState object first, once it's created,
	// initialize the Status subresource and then update the status.
...
func (r *NsBpfApplicationReconciler) createInitialBpfAppState(ctx context.Context) error {
...
func (r *NsBpfApplicationReconciler) updateBpfAppStateStatus(ctx context.Context, originalAppState *bpfmaniov1alpha1.BpfApplicationState) (bool, error) {
...
// status update).
func (r *NsBpfApplicationReconciler) waitForBpfAppStateSpecUpdate(ctx context.Context) error {
...
func (r *NsBpfApplicationReconciler) getBpfAppState(ctx context.Context) (*bpfmaniov1alpha1.BpfApplicationState, error) {
...
func (r *NsBpfApplicationReconciler) initBpfAppState() error {
	r.currentAppState = &bpfmaniov1alpha1.BpfApplicationState{
...
func (r *NsBpfApplicationReconciler) initializeNodeProgramList() error {
